...
.\tools\release\Review-VT7PtyRelease.ps1 `
    -ReleaseSetPath .\artifacts\packages\VT7Pty-0.5.0-dev-win7-x64-release-m0-rc6-release-set.json `
...
`VT7Pty-X.Y.Z-win7-x64-release`. Candidate suffixes such as `m0-rc6` identify
